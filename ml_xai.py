...
# XAI analysis for tree based classifiers
def xai(model, X, val):
...
# XAI analysis for non-tree based classifiers
...
no_doc_rdnF_60_none = ['known CAD', 'previous PCI', 'Diabetes', 'INCIDENT OF PRECORDIAL PAIN', 'RST ECG', 'male', '40b50'] # 77,59

x = x_nodoc #TODO commment when running with doctor
X = x
sel_features = no_doc_rdnF_60_none # input feature set to explain
sel_alg = rndF # input algorithm to explain
